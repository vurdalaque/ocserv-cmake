if ("${GEOIP_LIBRARY}" STREQUAL "geoip")
	...
	target_include_directories(${CMAKE_PROJECT_NAME} PRIVATE ${geoip_INCLUDE_DIRS})
	target_link_directories(${CMAKE_PROJECT_NAME} PRIVATE ${geoip_LIBRARY_DIRS})
	target_link_libraries(${CMAKE_PROJECT_NAME} PRIVATE ${geoip_LINK_LIBRARIES})
